...
if (empty($_SESSION['name'])) {
  ...
  <body>
    ...
    <div class="page-content p-5" id="content">
      ...
      <!-- ALPHA start -->
      <div id="ALPHA">
        <h2 class="text-center bg-success">ALPHA</h2>
        <form action="upload.php" method="post" class="border p-3" enctype="multipart/form-data">
          <div class="form-group">
            <input type="text" name="team" class="form-control text-mute" value="alpha" readonly>
          </div>
          <div class="form-group">
    ...
    <script>
      ...
      function del(file) {
        location.href="delete.php?team=alpha&file_name="+file;}
    </script>
  </body>
