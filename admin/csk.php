...
if (empty($_SESSION['name'])) {
  ...
  <head>
    ...
    <link rel="shortcut icon" href="includes/CSK.png" type="image/x-icon">
    <title>Dashboard | CSK</title>
    <style>
      .img {
        width: 25px;
        height: auto;
  ...
  <body>
    ...
    <div class="vertical-nav bg-white" id="sidebar">
      ...
      <ul class="nav flex-column bg-white mb-0">
        <li class="nav-item">
          <a href="/admin/csk.php" class="nav-link text-dark font-italic bg-light">
    ...
    <div class="page-content p-5" id="content">
      ...
      <!-- csk start -->
      <div id="CSK">
        <h2 class="text-center bg-warning">CSK</h2>
        <form action="upload.php" method="post" class="border p-3" enctype="multipart/form-data">
          <div class="form-group">
            <input type="text" name="team" class="form-control text-mute" value="csk" readonly>
          </div>
          <div class="form-group">
    ...
    <script>
      ...
      function del(file) {
        location.href="delete.php?team=csk&file_name="+file;
      }
    </script>
  </body>
