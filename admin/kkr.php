...
if (empty($_SESSION['name'])) {
  ...
  <head>
    ...
    <link rel="shortcut icon" href="includes/KKR.png" type="image/x-icon">
    <title>Dashboard | KKR</title>
    <style>
      .bg-purple {
  ...
  <body>
    ...
    <div class="vertical-nav bg-white" id="sidebar">
      ...
      <ul class="nav flex-column bg-white mb-0">
        ...
        <li class="nav-item">
          <a href="/admin/kkr.php" class="nav-link text-dark font-italic bg-light">
    ...
    <div class="page-content p-5" id="content">
      ...
      <!-- KKR start -->
      <div id="KKR">
        <h2 class="text-center bg-purple">KKR</h2>
        <form action="upload.php" method="post" class="border p-3" enctype="multipart/form-data">
          <div class="form-group">
            <input type="text" name="team" class="form-control text-mute" value="kkr" readonly>
          </div>
          <div class="form-group">
    ...
    <script>
      ...
      function del(file) {
        location.href="delete.php?team=kkr&file_name="+file;
      }
    </script>
  </body>
