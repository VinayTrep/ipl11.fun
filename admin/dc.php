...
<link rel="shortcut icon" href="includes/DC.png" type="image/x-icon">
...
<div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
      ...
      <li class="nav-item">
        <a href="/admin/dc.php" class="nav-link text-dark font-italic bg-light">
  ...
  <div class="page-content p-5" id="content">
    ...
    <div class="container-fluid">
      ...
      <!-- DC start -->
        <div id="DC">
            <h2 class="text-center bg-primary">DC</h2>
            <form action="upload.php" method="post" class="border p-3" enctype="multipart/form-data">
                <div class="form-group">
                    <input type="text" name="team" class="form-control text-mute" value="dc" readonly>
                </div>
                <div class="form-group">
...
<script>
  ...
  $('#sidebarCollapse').on('click', function() {
    $('#sidebar, #content').toggleClass('active');
      ...
      function del(file) {
        location.href="delete.php?team=dc&file_name="+file;
                 }
</script>
</body>
</html>
